...
class ClientResourceIT {
    ...
    private static final String DEFAULT_PHONE = "+9819605932";
    private static final String UPDATED_PHONE = "+7197";
    ...
    void partialUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.lastName(UPDATED_LAST_NAME).firstName(UPDATED_FIRST_NAME).phone(UPDATED_PHONE).address(UPDATED_ADDRESS);
